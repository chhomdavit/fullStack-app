...
import { Affix, Avatar, Badge, Button, Dropdown, Layout, Space } from 'antd';
import { BsFacebook, BsYoutube, BsTiktok, BsTelegram, BsInstagram, BsHouseHeart, BsFillPatchQuestionFill, BsFillInboxesFill, BsFillPCircleFill, BsCurrencyExchange, BsPersonFillExclamation } from "react-icons/bs";
import { MessageFilled, NotificationFilled, UserOutlined } from '@ant-design/icons';
...
;
    const navLinks = [
        ...
        { name: "Profile", route: "/profile", icon: <BsPersonFillExclamation /> },
        { name: "POS", route: "/pos", icon: <BsCurrencyExchange /> },
    ...
    const itemsProfile = [
        { key: '1', label: <span onClick={() => navigate("profile")}>My Account</span> },
        { key: '2', label: <span onClick={() => navigate("login")}>Login</span> },
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <Dropdown menu={{ items: itemsProfile }} placement="bottomRight">
                                        ...
                                        {customerProfile?.name?.slice(0, 2).toUpperCase() || "G"}
                                        </Avatar>
                                    </Dropdown>
                                </Space>
                            </div>
