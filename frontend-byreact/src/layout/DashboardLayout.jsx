...
import { BsCashCoin, BsFillPersonLinesFill, BsHddRack, BsImage, BsLockFill, BsPersonCircle } from 'react-icons/bs';


const DashboardLayout = () => {
  document.title = "Backend Dashboard";
  ...
  const items = [
    ...
    getItem('Customer', '/dashboard/customer', <BsFillPersonLinesFill />),
    getItem('Order', '/dashboard/order', <OrderedListOutlined />),
    getItem('Order Item', '/dashboard/order-item', <BsHddRack />),
    getItem('Payment', '/dashboard/payment', <BsCashCoin/>),
    getItem('Profile', '/dashboard/profile', <BsPersonCircle/>),
    getItem('image', '/dashboard/image', <BsImage/>),
  ];

  const itemsProfile = [
    { key: '1', label: <span onClick={() => navigate("/dashboard/profile")}>My Profile</span>, icon: <BsPersonCircle/> },
    { key: '2', label: <span>Change Password</span> },
    { key: '', label: <span onClick={handleLogout}><BsLockFill/> Logout</span> },
  ];
