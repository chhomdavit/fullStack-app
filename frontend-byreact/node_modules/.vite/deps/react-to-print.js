    ...
    !function(e, t) {
      ...
      return function() {
        ...
        function c(e2, t2) {
          ...
          setTimeout(() => {
            var t3, u2;
            if (e2.contentWindow) if (e2.contentWindow.focus(), c2) c2(e2).then(() => {
              null == n2 || n2(), l(s2);
            }).catch((e3) => {
              ...
              if (e2.contentWindow.print) {
                const n3 = null !== (u2 = null === (t3 = e2.contentDocument) || void 0 === t3 ? void 0 : t3.title) && void 0 !== u2 ? u2 : "", r3 = e2.ownerDocument.title;
        ...
        function h(e2, t2, o2, n2) {
          var r2, s2, l2, d2, h2;
          const { contentNode: f2, clonedContentNode: g2, clonedImgNodes: m, clonedVideoNodes: b, numResourcesToLoad: y, originalCanvasNodes: v } = o2, { bodyClass: w, fonts: E, ignoreGlobalStyles: A, pageStyle: T, nonce: x, suppressErrors: k, copyShadowRoots: S } = n2;
          e2.onload = null;
          const N = null !== (r2 = e2.contentDocument) && void 0 !== r2 ? r2 : null === (s2 = e2.contentWindow) || void 0 === s2 ? void 0 : s2.document;
          if (N) {
            const o3 = N.body.appendChild(g2);
            S && u(f2, o3, !!k), E && ((null === (l2 = e2.contentDocument) || void 0 === l2 ? void 0 : l2.fonts) && (null === (d2 = e2.contentWindow) || void 0 === d2 ? void 0 : d2.FontFace) ? E.forEach((o4) => {
              ...
              t2(e3);
            }), i({ messages: ['"react-to-print" is not able to load custom fonts because the browser does not support the FontFace API but will continue attempting to print the page'], suppressErrors: k })));
            const n3 = null != T ? T : p, r3 = N.createElement("style");
            x && (r3.setAttribute("nonce", x), N.head.setAttribute("nonce", x)), r3.appendChild(N.createTextNode(n3)), N.head.appendChild(r3), w && N.body.classList.add(...w.split(" "));
            const s3 = N.querySelectorAll("canvas");
            for (let e3 = 0; e3 < v.length; ++e3) {
              const t3 = v[e3], o4 = s3[e3];
              if (void 0 === o4) {
                i({ messages: ["A canvas element could not be copied for printing, has it loaded? `onBeforePrint` likely resolved too early.", t3], suppressErrors: k });
                continue;
              }
            ...
            const c2 = "select", y2 = f2.querySelectorAll(c2), C = N.querySelectorAll(c2);
            ...
            if (!A) {
              ...
              for (let o4 = 0, n4 = e3.length; o4 < n4; ++o4) {
                ...
                if ("style" === n5.tagName.toLowerCase()) {
                  const e4 = N.createElement(n5.tagName), t3 = n5.sheet;
                  if (t3) {
                    let r4 = "";
                    try {
...
`);
                    ...
                    e4.setAttribute("id", `react-to-print-${o4}`), x && e4.setAttribute("nonce", x), e4.appendChild(N.createTextNode(r4)), N.head.appendChild(e4);
                  }
                  ...
                  const e4 = N.createElement(n5.tagName);
                  ...
                  }, x && e4.setAttribute("nonce", x), N.head.appendChild(e4);
                }
        ...
        function g(e2) {
          const { contentRef: t2, fonts: o2, ignoreGlobalStyles: n2, onBeforePrint: r2, onPrintError: d2, preserveAfterPrint: u2, suppressErrors: p2 } = e2, h2 = (0, s.useCallback)((s2) => {
            l(u2, true);
            const h3 = function({ contentRef: e3, optionalContent: t3, suppressErrors: o3 }) {
            ...
            }({ contentRef: t2, optionalContent: s2, suppressErrors: p2 });
            if (!h3) return void i({ messages: ["There is nothing to print"], suppressErrors: p2 });
            const g2 = h3.cloneNode(true), m = document.querySelectorAll("link[rel~='stylesheet'], link[as='style']"), b = g2.querySelectorAll("img"), y = g2.querySelectorAll("video"), v = o2 ? o2.length : 0, w = (n2 ? 0 : m.length) + b.length + y.length + v, E = [], A = [], T = function() {
              ...
              E.includes(t3) ? i({ level: "debug", messages: ["Tried to mark a resource that has already been handled", t3], suppressErrors: p2 }) : (o3 ? (i({ messages: ['"react-to-print" was unable to load a resource but will continue attempting to print the page', ...o3], suppressErrors: p2 }), A.push(t3)) : E.push(t3), E.length + A.length === w && c(T, e2));
            }, k = { contentNode: h3, clonedContentNode: g2, clonedImgNodes: b, clonedVideoNodes: y, numResourcesToLoad: w, originalCanvasNodes: h3.querySelectorAll("canvas") };
            r2 ? r2().then(() => {
              f(T, x, k, e2);
            }).catch((e3) => {
              null == d2 || d2("onBeforePrint", a(e3));
            }) : f(T, x, k, e2);
          }, [e2]);
          return h2;
        }
